...
def test_catalog_has_thirty_unique_ids() -> None:
    """Twenty-six from Issue #34, the band factor Issue #72 made resolvable, the two
    reinforced spacing treatments Issue #110 extracted, and the permitted alternative to the
    impulse withstand test that Issue #37 needs the engineer to be able to choose."""

    assert len(semantic_ids.REQUIRED_SEMANTIC_IDS) == 30
