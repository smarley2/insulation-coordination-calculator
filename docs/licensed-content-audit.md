...
- First audited: 2026-08-13. Reconciled: 2026-08-18, after issue #110.
...
- Scanner totals now: inline-factor=2, inline-threshold=7, numeric-series=44,
  source-like-text=5, synthetic-iec-source=7, text-numeric-series=2
  (67 findings). Every `value-near-table-id` finding is resolved; the
