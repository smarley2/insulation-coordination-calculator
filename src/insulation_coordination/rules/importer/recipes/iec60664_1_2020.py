...
RECIPE = StandardRecipe(
    ...
    tables=(
            ...
            columns=tuple(
                ...
                for column in _columns(
                    (
                        ...
                        "impulse withstand voltage entering this table",
                        0,
                        "axis",
                        "kV",
                    ),
                    ("case_a_pd1_mm", "clearance for branch column 1", 1, "data", "mm"),
                    ("case_a_pd2_mm", "clearance for branch column 2", 2, "data", "mm"),
                    ("case_a_pd3_mm", "clearance for branch column 3", 3, "data", "mm"),
                    ("case_b_pd1_mm", "clearance for branch column 4", 4, "data", "mm"),
                    ("case_b_pd2_mm", "clearance for branch column 5", 5, "data", "mm"),
                    ("case_b_pd3_mm", "clearance for branch column 6", 6, "data", "mm"),
                )
            ),
        ),
        TableAuditSpec(
            ...
            columns=_columns(
                ("rms_voltage_v", "rms voltage entering this table", 0, "axis", "V"),
                ("pcb_pollution_1", "creepage for pollution branch column 1", 1, "data", "mm"),
                ("pcb_pollution_2", "creepage for pollution branch column 2", 2, "data", "mm"),
                ("other_pd1", "creepage context column 3", 3, "context", "mm"),
                ("other_pd2_group_i", "creepage context column 4", 4, "context", "mm"),
                ("other_pd2_group_ii", "creepage context column 5", 5, "context", "mm"),
                ("other_pd2_group_iii", "creepage context column 6", 6, "context", "mm"),
                ("other_pd3_group_i", "creepage context column 7", 7, "context", "mm"),
                ("other_pd3_group_ii", "creepage context column 8", 8, "context", "mm"),
                ("other_pd3_group_iii", "creepage context column 9", 9, "context", "mm"),
            ),
        ),
        TableAuditSpec(
            ...
            columns=_columns(
                ...
                ("case_a_mm", "clearance for field case column 1", 1, "data", "mm"),
                ("case_b_mm", "clearance for field case column 2", 2, "data", "mm"),
            ),
        ),
        TableAuditSpec(
            ...
            columns=_columns(
                ("peak_voltage_kv", "peak voltage entering this table", 4, "axis", "kV"),
                (
                    "partial_discharge_advice",
                    "advisory dimension on the same row",
                    5,
                    "data",
                    "mm",
                ),
        ...
        TableAuditSpec(
            ...
            columns=_columns(
                ("altitude_m", "altitude entering this table", 0, "axis", "m"),
                ("pressure_kpa", "pressure context on the same row", 1, "context", "kPa"),
                ("clearance_factor", "correction factor on the same row", 2, "data", "1"),
            ),
        ),
    ),
    formulas=(
